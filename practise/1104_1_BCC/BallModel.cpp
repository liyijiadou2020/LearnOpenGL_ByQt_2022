...
//     加载纹理
    auto _texture = new QOpenGLTexture(QImage(":/pic/03.png"));
    _texture->setMinificationFilter(QOpenGLTexture::LinearMipMapLinear);
    _texture->setMagnificationFilter(QOpenGLTexture::Linear);
    setTexture(_texture);

	auto _program = new QOpenGLShaderProgram();
    _program->addShaderFromSourceFile(QOpenGLShader::Vertex, ":/shader/b.vert");
    _program->addShaderFromSourceFile(QOpenGLShader::Fragment, ":/shader/b.frag");
