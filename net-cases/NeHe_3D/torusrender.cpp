...
TorusRender::TorusRender(QWidget *parent) : QOpenGLWidget(parent)
{
...
{
    userTexture_ = true;
    program_.addCacheableShaderFromSourceFile(QOpenGLShader::Vertex,":/shapers/vsrc.vert");
    program_.addCacheableShaderFromSourceFile(QOpenGLShader::Fragment,":/shapers/fsrc.frag");
    program_.link();
