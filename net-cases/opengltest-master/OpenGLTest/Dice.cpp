	...
	: Model()
{
	...
	auto _texture = new QOpenGLTexture(QImage(":/dice1000.png"));
	...
	_program->addShaderFromSourceFile(QOpenGLShader::Vertex, ":/vertex.shader");
	_program->addShaderFromSourceFile(QOpenGLShader::Fragment, ":/fragment.shader");
