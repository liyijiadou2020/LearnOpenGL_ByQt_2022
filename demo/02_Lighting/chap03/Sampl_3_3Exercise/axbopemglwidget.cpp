...
void AXBOpemglWidget::paintGL()
{
    ...
    // material properties
    m_ShaderProgram.setUniformValue("material.ambient", 0.0f, 0.1f, 0.06f);
    m_ShaderProgram.setUniformValue("material.diffuse", 0.0f, 0.50980392f, 0.50980392f);
    m_ShaderProgram.setUniformValue("material.specular", 0.50196078f, 0.50196078f, 0.50196078f);
